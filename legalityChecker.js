...
function getNoPromotionSquaresError(color, detailedUnitType) {
    ...
    switch (detailedUnitType) {
        case 'Q':
            return color == "w" ? error_noWhitePromotionSquaresForQueen : error_noBlackPromotionSquaresForQueen;
        case 'R':
            return color == "w" ? error_noWhitePromotionSquaresForRook : error_noBlackPromotionSquaresForRook;
        case 'BL':
        case 'BD':
            return color == "w" ? error_noWhitePromotionSquaresForBishop : error_noBlackPromotionSquaresForBishop;
        case 'N':
            return color == "w" ? error_noWhitePromotionSquaresForKnight : error_noBlackPromotionSquaresForKnight;
        default:
            assert(false, "Unexpected detailed unit type " + detailedUnitType);
    }
}
...
function cannotBePromoted(file, rank) {
    ...
    if (board[file][rank].color == "w") {
        switch (board[file][rank].unit) {
            case 'Q':
                return error_impossiblePromotedWhiteQueen;
            case 'R':
                return error_impossiblePromotedWhiteRook;
            case 'B':
                return error_impossiblePromotedWhiteBishop;
            case 'N':
                return error_impossiblePromotedWhiteKnight;
            default:
                assert(false, 'Unexpected promoted white piece ' + board[file][rank].unit + ' file ' +
                    file + ' rank ' + rank);
        }
    } else if (board[file][rank].color == "b") {
        switch (board[file][rank].unit) {
            case 'Q':
                return error_impossiblePromotedBlackQueen;
            case 'R':
                return error_impossiblePromotedBlackRook;
            case 'B':
                return error_impossiblePromotedBlackBishop;
            case 'N':
