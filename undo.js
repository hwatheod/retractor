...
class UndoStack {
	...
	undoOneItem(undoItem) {
		...
		switch(undoItem.operation) {
			...
			case CHANGE_TOTAL_CAPTURE_COUNT: positionData.totalCaptureCounts[undoItem.oldValue[0]] = undoItem.oldValue[1]; break;
			case CHANGE_PROMOTED_COUNT: positionData.promotedCounts[undoItem.oldValue[0] + undoItem.oldValue[1]] = undoItem.oldValue[2]; break;
			case RECORD_MOVE: this.moveCount--;
		}
	}
	...
	redoOneItem(undoItem) {
		...
		switch(undoItem.operation) {
			...
			case CHANGE_TOTAL_CAPTURE_COUNT: positionData.totalCaptureCounts[undoItem.newValue[0]] = undoItem.newValue[1]; break;
			case CHANGE_PROMOTED_COUNT: positionData.promotedCounts[undoItem.newValue[0] + undoItem.newValue[1]] = undoItem.newValue[2]; break;
			case RECORD_MOVE: this.moveCount++;
		}
	}
