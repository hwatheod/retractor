...
describe("illegalities related to strong cages", function() {
    ...
    nonKnightPieces.forEach(piece => {
        it("white " + piece + " illegally placed in enemy cage", function() {
            ...
            switch(piece) {
                ...
                case "B": expect(errorText[startPlay()]).toBe(errorText[error_illegallyPlacedWhiteBishop]); break;
            }
        });
    })
    ...
    nonKnightPieces.forEach(piece => {
        it("black " + piece + " illegally placed in enemy cage", function() {
            ...
            setRetract("b");
            switch(piece) {
                case "Q": expect(errorText[startPlay()]).toBe(errorText[error_illegallyPlacedBlackQueen]); break;
                case "R": expect(errorText[startPlay()]).toBe(errorText[error_illegallyPlacedBlackRook]); break;
                case "B": expect(errorText[startPlay()]).toBe(errorText[error_illegallyPlacedBlackBishop]); break;
            }
        });
    });
